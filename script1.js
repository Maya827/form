...
<div class="form-row">
    <div class="form-group col-md-4">        
        <div class="form-check form-check-inline">    
            <input class="form-check-input multi-choice" type="checkbox" name="food" id="Dosa" value="Dosa">
            <label class="form-check-label" for="Dosa">Dosa</label>
        </div>
        <div class="form-check form-check-inline">
            <input class="form-check-input multi-choice" type="checkbox" name="food" id="Idly" value="Idly">
            <label class="form-check-label" for="Idly">Idly</label>
        </div>
    </div>
    <div class="form-group col-md-4">
        <div class="form-check form-check-inline">
            <input class="form-check-input multi-choice" type="checkbox" name="food" id="Chappathi" value="Chappthi">
            <label class="form-check-label" for="Chappathi">Chappathi</label>
        </div>
        <div class="form-check form-check-inline">
            <input class="form-check-input multi-choice" type="checkbox" name="food" id="Rice" value="Rice">
            <label class="form-check-label" for="Rice">Rice</label>
        </div>
    </div>
    <div class="form-group col-md-4">
        <div class="form-check form-check-inline">
            <input class="form-check-input multi-choice" type="checkbox" name="food" id="Burger" value="Burger">
            <label class="form-check-label" for="Burger">Burger</label>
        </div>
        <div class="form-check form-check-inline">
            <input class="form-check-input multi-choice" type="checkbox" name="food" id="Pizza" value="Pizza">
